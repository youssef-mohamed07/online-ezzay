...
with open('lib/views/screens/dashboard_page.dart', 'r') as f:
    content = f.read()
...
content = content.replace(
    ...
    final imageUrl = (shipment['image'] ?? shipment['image_url'] ?? '').toString();""",
    new_logic
)

with open('lib/views/screens/dashboard_page.dart', 'w') as f:
    f.write(content)
