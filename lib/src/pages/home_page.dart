    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            const SizedBox(height: 8), // Breathing room for header
            _TopHeader(
            ...
            const SizedBox(height: 28),
            const _SectionTitle('تتبع الشحنة'),
            const SizedBox(height: 12),
            const _TrackingCard(),
            const SizedBox(height: 24),
            const _SectionTitle('الشحنات النشطة'),
            const SizedBox(height: 12),
            const _ActiveShipmentCard(),
            const SizedBox(height: 24),
            const _SectionTitle('طرود في المستودع'),
            const SizedBox(height: 12),
            ...
            Row(
              ...
              children: [
                const _SectionTitle('العناوين'),
                GestureDetector(
                  onTap: () => _openPage(const PackagesPage()),
                  child: const Text('الباقات', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFFE71D24))),
                ),
              ],
            ),
            const SizedBox(height: 12),
      ...
      children: [
        Column(
          ...
          children: [
            Row(
              children: [
                const Text('مرحبا كريم', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w900, color: Color(0xFF1E293B))),
                const SizedBox(width: 8),
                const Text('', style: TextStyle(fontSize: 20)),
              ],
            ),
            const SizedBox(height: 2),
            const Text('لديك 3 شحنات نشطة', style: TextStyle(fontSize: 12, color: Color(0xFF94A3B8), fontWeight: FontWeight.w600)),
          ],
        ),
        Row(
          children: [
      ...
      child: Row(
        children: [
          ...
          ElevatedButton(
            ...
            child: const Text('تتبع', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
          ),
        ],
      ),
    );
    ...
    return Container(
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Row(
                ...
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.inventory_2_rounded, size: 28, color: Color(0xFFC68A5A)),
                  ),
                  const SizedBox(width: 16),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('طرد أمازون', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800, color: Color(0xFF1E293B))),
                      const SizedBox(height: 2),
              ...
              Container(
                ...
                child: const Text('في الصندوق', style: TextStyle(color: Color(0xFFD97706), fontSize: 12, fontWeight: FontWeight.bold)),
              ),
            ],
          ),
          const SizedBox(height: 28),
          Row(
            children: [
              Expanded(child: _buildTimelineStep('في الصندوق', isActive: false, isCompleted: true)),
              _buildTimelineLine(isCompleted: true),
              Expanded(child: _buildTimelineStep('في الطريق', isActive: true, isCompleted: false)),
              _buildTimelineLine(isCompleted: false),
              Expanded(child: _buildTimelineStep('تم التسليم', isActive: false, isCompleted: false)),
            ],
          ),
      ...
      child: Row(
        ...
        children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('اطلب إرسال طردك', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w900, color: Color(0xFF1E293B))),
              const SizedBox(height: 12),
              ElevatedButton(
                onPressed: onTap ?? () {},
                style: ElevatedButton.styleFrom(
                ...
                child: const Text('اطلب توصيل الآن', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
              ),
            ],
          ),
          Container(
            ...
            child: const Icon(Icons.inventory_2_rounded, size: 36, color: Color(0xFFC68A5A)),
          ),
        ],
      ),
    );
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    const Icon(Icons.place_rounded, color: Color(0xFFE71D24), size: 18),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: const Text('اطلب الآن', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                  ),
                ),
              ],
            ),
