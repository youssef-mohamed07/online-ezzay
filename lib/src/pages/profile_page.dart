...
class _ProfilePageState extends State<ProfilePage> with SingleTickerProviderStateMixin {
    ...
    return ListView(
      children: [
        ...
        Center(
          child: TextButton(
            onPressed: () {},
            child: const Text('تسجيل الخروج', style: TextStyle(color: Colors.red, fontSize: 16, fontWeight: FontWeight.bold)),
          ),
        ),
  ...
  Widget _buildAccountMenuCard() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text('حسابي', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF2C3E50))),
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('محمد أحمد', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: Color(0xFF2C3E50))),
  ...
  Widget _buildServicesCard() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('خدمات اخرى', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF2C3E50))),
          const SizedBox(height: 8),
            ...
            children: [
              ...
              if (isFailed)
                Container(
                  ...
                  child: const Text('فشل', style: TextStyle(color: Colors.red, fontSize: 12, fontWeight: FontWeight.bold)),
                ),
            ],
          ),
          const SizedBox(height: 16),
            ...
            children: [
              Expanded(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('عرض الطلب', style: TextStyle(color: Colors.white)),
                ),
              ),
              ...
              Expanded(
                ...
                child: OutlinedButton(
                  ...
                  child: const Text('الدفع', style: TextStyle(color: Colors.red)),
                ),
              ),
              const SizedBox(width: 8),
              Expanded(
  ...
  Widget _buildShipmentsTab() {
    return ListView(
      children: [
        _buildTopProfileSection(),
        _buildShipmentItem('8742638', 'في الصندوق', true, 'الوزن 2.5 كجم | تاريخ 12 مايو'),
        _buildShipmentItem('6654429', 'في الطريق', false, null),
      ],
    );
  }
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text('رقم التتبع : $trackingNumber', style: const TextStyle(fontWeight: FontWeight.bold)),
              Container(
                width: 60,
                height: 60,
                decoration: BoxDecoration(
                ...
                child: const Icon(Icons.inbox, color: Colors.grey), // Placeholder for image
              )
            ],
          ),
          Container(
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text('في الصندوق', style: TextStyle(fontSize: 10, color: Colors.grey)),
              const Text('في الطريق', style: TextStyle(fontSize: 10, color: Colors.grey)),
              const Text('تم التسليم', style: TextStyle(fontSize: 10, color: Colors.grey)),
            ],
          ),
          const SizedBox(height: 16),
          Row(
            ...
            children: [
              ...
              if (details != null)
                Row(
                  children: [
                    const Text('عرض التفاصيل', style: TextStyle(color: Colors.red, fontWeight: FontWeight.bold, fontSize: 13)),
                    const SizedBox(width: 8),
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('عنوان الفاتورة', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Color(0xFF2C3E50))),
              const SizedBox(height: 4),
              const Text('تعديل عنوان الفاتورة', style: TextStyle(color: Colors.red, fontSize: 13, decoration: TextDecoration.underline)),
              const SizedBox(height: 16),
