      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            _buildSwitchTile('الإشعارات', _notificationsEnabled, (val) {
              setState(() => _notificationsEnabled = val);
            }),
            _buildListTile('اللغة', 'العربية', Icons.language, () {
              Navigator.push(context, MaterialPageRoute(builder: (_) => const LanguagePage()));
            }),
            
            const SizedBox(height: 24),
            _buildSectionHeader('المزيد'),
            _buildListTile('تغيير كلمة المرور', null, Icons.lock_outline, () {
              Navigator.push(context, MaterialPageRoute(builder: (_) => const ChangePasswordPage()));
            }),
            _buildListTile('سياسة الخصوصية', null, Icons.privacy_tip_outlined, () {
              Navigator.push(context, MaterialPageRoute(builder: (_) => const PrivacyPolicyPage()));
            }),
            _buildListTile('شروط الخدمة', null, Icons.description_outlined, () {
              Navigator.push(context, MaterialPageRoute(builder: (_) => const TermsOfServicePage()));
            }),
            _buildListTile('تواصل معنا', null, Icons.contact_support_outlined, () {
              Navigator.push(context, MaterialPageRoute(builder: (_) => const ContactUsPage()));
            }),
            _buildListTile('حول التطبيق', 'الإصدار 1.0.0', Icons.info_outline, () {
