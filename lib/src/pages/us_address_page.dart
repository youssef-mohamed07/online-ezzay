            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    _buildLabel('الشحن من'),
                    _buildDropdown(
                      hint: 'الشحن من',
                      value: _shipFrom,
                      items: ['أمريكا', 'الصين', 'الإمارات'],
                      onChanged: (val) => setState(() => _shipFrom = val),
                    ),
                    const SizedBox(height: 16),

                    _buildLabel('التسليم الي'),
                    _buildDropdown(
                      hint: 'التسليم الي',
                      value: _deliverTo,
                      items: ['السعودية', 'مصر', 'الأردن'],
                      onChanged: (val) => setState(() => _deliverTo = val),
                    ),
                    const SizedBox(height: 16),

                    _buildLabel('اختر الخدمة'),
                    _buildDropdown(
                      hint: 'DHL',
                      value: _service,
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: _buildDropdown(
                            ...
                            value: _weightUnit,
                            items: ['كجم', 'باوند'],
                            onChanged: (val) => setState(() => _weightUnit = val ?? 'كجم'),
                          ),
                        ),
                      ],
                    ),
