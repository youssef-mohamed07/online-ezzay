      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            SizedBox(height: 16),
            _buildTextField('رقم الهاتف'.tr, '+966 5xxxxxxxx', TextInputType.phone),
            SizedBox(height: 40),
            ElevatedButton(
              ...
              child: Text('حفظ التعديلات', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.white)),
            ),
          ],
        ),
      ),
